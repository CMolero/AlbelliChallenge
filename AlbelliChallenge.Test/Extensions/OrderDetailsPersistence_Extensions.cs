...
namespace AlbelliChallenge.Test.Extensions
{
    public static class OrderDetailsPersistence_Extensions
    {
        ...
        public static OrderDetailsPersistence WithAllProducts(this OrderDetailsPersistence instance, int nMugs)
        {
            instance = new OrderDetailsPersistence
            {
                OrderId = 1,
                Products = new List<ProductPersitence>()
                {
                    ...
                    new ProductPersitence() { ProductType = Enums.ProductTypes.Cards, Quantity = 13 },
                    new ProductPersitence() { ProductType = Enums.ProductTypes.Mug, Quantity = nMugs }
                },
                RequiredBinWidth = 0.0
            };
